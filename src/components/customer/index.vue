<template>
  <div class="__p_C7_u_238">
    ...
    >
      ...
      <el-table-column label="级别" prop="leavel" align="center" header-align="center"></el-table-column>
      <el-table-column label="余额" prop="moeny" align="center" header-align="center"></el-table-column>
      <el-table-column label="权限" prop="permissions" align="center" header-align="center"></el-table-column>
...
export default {
  ...
  methods: {
    go2Query() {
      this.axios.get("http://localhost:3000/api/getalluser",{
        params:{
